...
# IT
companies = application.search_company(selectors=[{'companies': ['name']}], 
                                                                 params={ 'facet' : ['location,ie:0','industry,118,109,3,4,5,6,140,84,96'] })                                                                 
...
for element in pages:
    comps = application.search_company(selectors=[{'companies': ['name', 'website-url', 'specialties','company-type',
                                                                 ...
                                                                 'founded-year','num-followers',]}],  params={'facet' : ['location,ie:0','industry,118,109,3,4,5,6,140,84,96'], 'count': 20, 'start': element})
    companies_IT.append(comps)
        
        
with open('companies_IT.json', 'w') as outfile:
        json.dump(companies_IT, outfile, indent=4)        
