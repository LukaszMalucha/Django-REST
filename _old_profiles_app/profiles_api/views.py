...
class UserProfileViewSet(viewsets.ModelViewSet):
    ...
    search_fields = ('name', 'email',)  # /?search=a


class UserLoginApiView(ObtainAuthToken):
    """Handle creating user authentication tokens"""
    renderer_classes = api_settings.DEFAULT_RENDERER_CLASSES  # has to be added manually for ObtainAuthToken
...
class UserProfileFeedViewSet(viewsets.ModelViewSet):
    ...
    def perform_create(self, serializer):
        ...
        serializer.save(user_profile=self.request.user)  # addition to all serializer fields validated
